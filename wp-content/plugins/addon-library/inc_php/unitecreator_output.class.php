...
class UniteCreatorOutputWork extends HtmlOutputBaseUC{
	...
	private function getAddonParams(){
		...
		$this->paramsCache = $this->addon->getProcessedMainParamsValuesForOutput();
		return($this->paramsCache);
	}
	...
	private function initTemplate(){
		...
		if($this->isItemsExists == true){
			...
			$arrItemData = $this->addon->getProcessedItemsData(UniteCreatorParamsProcessor::PROCESS_TYPE_OUTPUT);
