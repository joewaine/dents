function UniteCreatorParamsPanel(){
	 ...
	 */
	function addParam(objParamInput, type, filter){
				
		if(typeof objParamInput == "string"){
			var objParam = {
				name: objParamInput,
				type: "uc_textfield"
			};
		}else{
			var objParam = jQuery.extend({},objParamInput);
		}
