				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer">
					...
					<tr>
						<td align="center" valign="top">
							...
							<table width="100%"
							       style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #FFFFFF !important;">
								<tr>
									<td style="padding-top: 50px;padding-right: 50px;padding-bottom: 29px;padding-left: 50px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #555555;font-family: 'Roboto', Arial, sans-serif;font-size: 16px;line-height: 150%;text-align: left;font-weight: 300;">
										<?php echo $message ?>
									</td>
								</tr>
							</table>
