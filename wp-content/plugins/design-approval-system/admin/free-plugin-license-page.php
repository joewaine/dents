 ...
 * @since 2.1.6
 */
class das_Free_Plugin_License_Page {

    public $prem_plugins = '';
    public $main_menu_slug = 'edit.php?post_type=designapprovalsystem';
    public $license_page_slug = 'das-license-page';
    ...
    function __construct() {
        ...
        $this->prem_plugins = array(
            'das_premium' => array(
                'title' => 'DAS Premium Extension',
                'plugin_url' => 'das-premium/das-premium.php',
                'demo_url' => 'http://www.slickremix.com/testblog/',
                'purchase_url' => 'https://www.slickremix.com/downloads/das-premium/',
            ),
            'das_custom_emails' => array(
                'title' => 'DAS Custom Emails Extension',
                'plugin_url' => 'das-custom-emails/das-custom-emails.php',
                'demo_url' => 'http://www.slickremix.com/testblog/',
                'purchase_url' => 'https://www.slickremix.com/downloads/das-custom-emails-extension/',
            ),
            'das_manager' => array(
                'title' => 'DAS Manager Extension',
                'plugin_url' => 'das-manager/das-manager.php',
                'demo_url' => 'http://www.slickremix.com/testblog/',
                'purchase_url' => 'https://www.slickremix.com/downloads/das-manager-extension/',
            ),
        );
        $this->install();
    }
    ...
    function add_option_setting($args) {
        ...
        ?>
        <tr valign="top" class="das-license-wrap">
    ...
    function license_menu() {
        ...
        if (isset($submenu[$this->main_menu_slug]) && !in_array($this->license_page_slug, wp_list_pluck($submenu[$this->main_menu_slug], 2))) {
            ...
            add_submenu_page( $this->main_menu_slug, __('Plugin License', 'design-approval-system'), __('Plugin License', 'design-approval-system'), 'manage_options', 'das-license-page', array($this, 'license_page') );
        }
    }
    ...
    function license_page() {
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php" class="das-license-master-form">
     ...
     * @since 2.1.6
     */
    function display_premium_needed_license($args = array()) {
        ...
        <tr valign="top" class="das-license-wrap">
            ...
            <td>
                <div class="das-no-license-overlay">
                    <div class="das-no-license-button-wrap"
                    ">
                    <a class="das-no-license-button-purchase-btn" href="<?php echo $this->demo_url ?>" target="_blank">Demo</a>
                    <a class="das-no-license-button-demo-btn" href="<?php echo $this->purchase_url ?>" target="_blank">Buy
                        Extension</a>
                </div>
                </div>
...
new das_Free_Plugin_License_Page();
?>