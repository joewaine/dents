...
$manager_name_type = 'select_manager_name';
$manager_email_type = 'select_manager_email';
...
$custom_meta_fields_tab1 = array(
	...
	array(
		...
		'desc' => __('Notes about the project.<br/><small>(Notes appear under the Design Comments section of your design)</small>', 'design-approval-system'),
...
// 	),
	array(
		...
		'desc' => __('Notes from the client about the project. When a client submits comments on the design page they will show up here.', 'design-approval-system'),
...
$custom_meta_fields_tab3 = array(
	...
	array(
		'label'=> __('Approved Signature:', 'design-approval-system'),
    ...
    array(
        'label'=> __('Approved Date:', 'design-approval-system'),
        'desc' => __('The date the client approved the design.', 'design-approval-system'),
        'id' => $prefix.'client_approved_date',
        'type' => 'text'
    ),
	array(
		'label'=> __('Approved Comments:', 'design-approval-system'),
		'desc' => __('If Approved, your clients digital comments will be here.', 'design-approval-system'),
		'id' => $prefix.'client_approved_comments',
		'type' => 'text'
	)
);
//TAB4
...
if (is_plugin_active('das-premium/das-premium.php')) {
    ...
    $custom_meta_fields_tab5[] = array(
        'label'=> __('Show Purchase Order title', 'design-approval-system'),
        'desc' => __('Show Purchase Order title instead of Price title.', 'design-approval-system'),
        'id' => $prefix.'woo_po_text',
        'type' => 'select',
        'options' => array (
            'two' => array (
                'label' => __('No, Show Price title', 'design-approval-system'),
                'value' => 'no', 'design-approval-system'
            ),
            'one' => array (
                'label' => __('Yes, Show Purchase Order title', 'design-approval-system'),
                'value' => 'yes', 'design-approval-system'
            )
        )
    );
}//END IF WOO for DAS
...
//TAB 8
$custom_meta_fields_tab8 = array(
    array(
        'label'=> __('Manager\'s Name:', 'design-approval-system'),
        'desc' => __('Full name of DAS Manager on this project.<br/><small>(This will be used on the design template)</small>', 'design-approval-system'),
        'id' => $prefix.'manager_name',
        'type' => $manager_name_type
    ),
    array(
        'label'=> __('Designer\'s Email:', 'design-approval-system'),
        'desc' => __('Email address of DAS Manager for this project.<br/><small>(Only 1 email address allowed)</small>', 'design-approval-system'),
        'id' => $prefix.'manager_email',
        'type' => $manager_email_type
    ),
    array(
        'label'=> "Manager Comments:",
        'desc' => __('When a Manager submits comments or changes about this design page they will show up here.', 'design-approval-system'),
        'id' => $prefix.'manager_notes',
        'type' => 'textarea'
    ),
    array(
        'label'=> __('Design Approved:', 'design-approval-system'),
        'desc' => __('Did the Manager approve this version? If Yes, a STAR will appear for that project & version on your Project Board. This option will automatically change to "Yes" if a Manager submits their signature, but you can change it manually if you like. Once this option is set to "Yes" your client will not be able to approve this project version from the front end.', 'design-approval-system'),
        'id' => $prefix.'manager_approved',
        'type' => 'select',
        'options' => array (
            'No' => array (
                'label' => __('No', 'design-approval-system'),
	...
	array(
        'label'=> __('Approved Signature:', 'design-approval-system'),
        'desc' => __('If Approved, the Manager\'s digital signature will be here.', 'design-approval-system'),
        'id' => $prefix.'manager_approved_signature',
        'type' => 'text'
    ),
    array(
        'label'=> __('Approved Date:', 'design-approval-system'),
        'desc' => __('The date the Manager approved the design.', 'design-approval-system'),
        'id' => $prefix.'manager_approved_date',
        'type' => 'text'
    ),
	array(
        'label'=> __('Approved Comments:', 'design-approval-system'),
        'desc' => __('If Approved, the Manager\'s digital comments will be here.', 'design-approval-system'),
        'id' => $prefix.'manager_approved_comments',
        'type' => 'text'
    )
);
...
function show_custom_das_meta_box() {
	global $custom_meta_fields_tab1, $custom_meta_fields_tab2, $custom_meta_fields_tab3, $custom_meta_fields_tab4, $custom_meta_fields_tab5, $custom_meta_fields_tab6, $custom_meta_fields_tab7, $custom_meta_fields_tab8, $post;
	...
	<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header">
        <?php if (is_plugin_active('das-manager/das-manager.php')) { ?><li id="das-id-8"><a href="#das-tabs-8"><?php _e('Manager Info', 'design-approval-system') ?></a></li><?php } ?>
    ...
    //////////////////////////
    // Begin the field table and loop
    echo '<div id="das-tabs-8" class="ui-tabs-panel ui-widget-content"><div class="das-tab-content-padding">';
    foreach ($custom_meta_fields_tab8 as $field) {
        // get value of this field if it exists for this post
        $meta = get_post_meta($post->ID, $field['id'], true);
        // begin a table row with
        echo '
        ...
        switch ($field['type']) {
            ...
            case 'text':
                ...
                break;
            // Designer Name
            case 'select_manager_name':
                echo '<select name="'.$field['id'].'" id="'.$field['id'].'">';
                echo "<option value=''>";
                _e('Please Select DAS Manager', 'design-approval-system');
                echo "</option>";
                // $designer_roles = get_option('das-settings-designer-role');
                // we are hardcoding the das_manager role for now
                $designer_users_name = get_users('blog_id=1&orderby=display_name&role=das_manager');
                foreach ($designer_users_name as $user) {
                    $designer_name = $user->display_name;
                    $designer_email = $user->user_email;
                    $row = $designer_name;
...
function save_custom_meta($post_id) {
	global $custom_meta_fields_tab1, $custom_meta_fields_tab2, $custom_meta_fields_tab3, $custom_meta_fields_tab4, $custom_meta_fields_tab5,  $custom_meta_fields_tab6,  $custom_meta_fields_tab7,  $custom_meta_fields_tab8;
