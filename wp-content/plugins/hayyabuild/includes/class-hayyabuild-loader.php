...
class HayyaBLoader {
  	 ...
  	 */
   	...
   	public function __construct() {
   		require_once HAYYAB_PATH. 'includes/class-hayyabuild-helper.php';
   		require_once HAYYAB_PATH . 'includes/class-hayyabuild-modules.php';
   		if ( is_admin() ) {
   			require_once HAYYAB_PATH. 'includes/class-hayyabuild-admin.php';
   			require_once HAYYAB_PATH. 'admin/class-hayyabuild-hooks.php';
   		}
   		else {
   			require_once HAYYAB_PATH. 'includes/class-hayyabuild-shortcodes.php';
			require_once HAYYAB_PATH. 'includes/class-hayyabuild-public.php';
   		}
   		$this->actions 	= array();
   		$this->filters 	= array();
   		return true;
