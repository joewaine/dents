...
class HayyaModule_hb_icon
{
	...
	public function __construct() {
		...
		$this->params = array(
				'icon' => array(
						...
						'description' => __('You can use bootstrap icons or fontawesome.', HAYYAB_BASENAME),
				),
				'size' => array(
						'type' => 'integer_slider',
	...
	public function admin_render($param = null) {
		$args = array(
				'icon' => '<i id="'.$param['id'].'" class="'.$param['icon'].'" style="font-size: '.$param['size'].'px;'.$param['style'].'"></i>',
				'link' => array(
						null => $param['icon'],
