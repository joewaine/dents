...
function kswr_shortcode_form_default($shortcodeName){
	...
	$defaultValues = array(	
		'skillbar' =>  array(
			...
			'skl_strips'			=> 'none',
			'skl_title_color'		=> '#333',
			'skl_font_style'		=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		...
		'radialprogress' =>  array(			
			...
			'rad_content_fontstyle'	 => 'font-family:Default;font-weight:inherit;font-style:inherit;',
		...
		'alertbox' =>  array(	
			...
			'albx_title_ftstyle'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'albx_message_ftsize'			=> 'font-size:13px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'albx_message_ftstyle'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;'	
		),
		'bfimage' =>  array(
		...
		'teammate' =>  array(	
			...
			'tmmate_name_ftstyle'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'tmmate_position_ftsize'		=> 'font-size:13px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'tmmate_position_ftstyle'		=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		...
		'iconboxaction' =>  array(	
			...
			'icbb_title_style'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'icbb_title_size'				=> 'font-size:17px;line-height:;letter-spacing:;',
			'icbb_subtitle_style'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'icbb_subtitle_size'			=> 'font-size:14px;line-height:;letter-spacing:;',
			'icbb_info_style'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'icbb_info_size'				=> 'font-size:14px;line-height:;letter-spacing:;',

			'icbb_button_style'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		...
		'interactiveiconbox' =>  array(	
			...
			'iib_title_font_style'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'iib_subtitle_font_size'			=> 'font-size:14px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'iib_subtitle_font_style'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'iib_info_font_size'				=> 'font-size:14px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'iib_info_font_style'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;'		
		),
		'dropcaps' =>  array(
			'drpcp_letter_fstyle'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'drpcp_letter_fsize'				=> 'font-size:17px;',
			'drpcp_content_fstyle'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		...
		'iconboxinfo' =>  array(	
			...
			'ibi_title_fstyle'					=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'ibi_subtitle_fsize'				=> 'font-size:12px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'ibi_subtitle_fstyle'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'ibi_content_fsize'					=> 'font-size:15px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'ibi_content_fstyle'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		),
		'infolist' =>  array(	
			'iibl_align'						=>	'left',
			'iibl_margin'						=>	'30',
			...
			'iibl_title_fstyle'					=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'iibl_subtitle_fsize'				=> 'font-size:12px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'iibl_subtitle_fstyle'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'iibl_content_fsize'				=> 'font-size:13px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'iibl_content_fstyle'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		),
		'counter' =>  array(	
			//Icon 
			...
			'cnt_title_fstyle'					=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'cnt_value_fsize'					=> 'font-size:26px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'cnt_value_fstyle'					=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'cnt_prefix_fsize'					=> 'font-size:15px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'cnt_prefix_fstyle'					=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'cnt_suffix_fsize'					=> 'font-size:15px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'cnt_suffix_fstyle'					=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		),
		'pricingplan' =>  array(	
		...
		'cardflip' =>  array(
			...
			'cflp_front_title_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'cflp_front_subtitle_fsize'				=>	'font-size:16px;line-height:;letter-spacing:;',
			'cflp_front_subtitle_fstyle'			=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'cflp_back_title_fsize'					=>	'font-size:21px;line-height:;letter-spacing:;',
			'cflp_back_title_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'cflp_back_subtitle_fsize'				=>	'font-size:16px;line-height:;letter-spacing:;',
			'cflp_back_subtitle_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'cflp_back_button_fsize'				=>	'font-size:13px;line-height:;letter-spacing:;',
			'cflp_back_button_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
		),		
		'threedcardflip' =>  array(
			...
			'trcflp_front_title_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'trcflp_front_subtitle_fsize'			=>	'font-size:16px;line-height:;letter-spacing:;',
			'trcflp_front_subtitle_fstyle'			=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'trcflp_back_title_fsize'				=>	'font-size:21px;line-height:;letter-spacing:;',
			'trcflp_back_title_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'trcflp_back_subtitle_fsize'			=>	'font-size:16px;line-height:;letter-spacing:;',
			'trcflp_back_subtitle_fstyle'			=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'trcflp_back_button_fsize'				=>	'font-size:13px;line-height:;letter-spacing:;',
			'trcflp_back_button_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
		),
		...
		'modernflipbox' =>  array(
			...
			'mdnflb_front_title_fstyle'					=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'mdnflb_front_subtitle_fsize'				=>	'font-size:16px;line-height:;letter-spacing:;',
			'mdnflb_front_subtitle_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'mdnflb_back_title_fsize'					=>	'font-size:21px;line-height:;letter-spacing:;',
			'mdnflb_back_title_fstyle'					=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'mdnflb_back_subtitle_fsize'				=>	'font-size:16px;line-height:;letter-spacing:;',
			'mdnflb_back_subtitle_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
			'mdnflb_back_button_fsize'					=>	'font-size:13px;line-height:;letter-spacing:;',
			'mdnflb_back_button_fstyle'					=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
		),
		'imagebanner' => array(
			'imban_title_fsize'				=> 'font-size:28px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'imban_title_fstyle'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'imban_content_fsize'			=> 'font-size:20px;line-height:;letter-spacing:;--tablet-font-size:;--phone-font-size:;',
			'imban_content_fstyle'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
			'imban_btn_width'				=> '250',
			'imban_btn_height'				=> '45',
