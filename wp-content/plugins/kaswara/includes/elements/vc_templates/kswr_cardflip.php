...
function kswr_cardflip_shortC($atts) {  
	...
	$subtitleBackStyle = $cflp_back_subtitle_fsize .' '. $cflp_back_subtitle_fstyle .'color:'. $cflp_back_subtitle_color .';'. $cflp_back_subtitle_mr;
 	...
 	$outPut = '<div class="kswr-cflp-container kswr-theelement" data-layout="'.esc_attr($cflp_layout).'" data-smootheffect="'.esc_attr($cflp_transition).'" style="min-height:'.$cflp_minheight.'px;">
	...
	$outPut .='<div class="kswr-cflp-insider">
