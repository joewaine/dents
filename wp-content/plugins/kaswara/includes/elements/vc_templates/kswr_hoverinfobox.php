...
function kswr_hoverinfobox_shortC($atts) {  
	//Hover info box Attributes
 	extract(shortcode_atts(array(						
		...
		'hvbx_title_fstyle'				=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
		'hvbx_subtitle_fsize'			=>	'font-size:14px;line-height:;letter-spacing:;',
		'hvbx_subtitle_fstyle'			=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
		'hvbx_content_fsize'			=>	'font-size:15px;line-height:;letter-spacing:;',
		'hvbx_content_fstyle'			=>	'font-family:Default;font-weight:inherit;font-style:inherit;',
