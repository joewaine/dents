...
function kswr_pricebox_shortC($atts, $content = null) {  
	//Price Box Attributes
 	extract(shortcode_atts(array(						
 		...
 		'prbx_name_fstyle' 				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
 		'prbx_subtitle_fsize'			=> 'font-size:13px;line-height:;letter-spacing:;',
 		'prbx_subtitle_fstyle'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
 		'prbx_price_fsize' 				=> 'font-size:21px;line-height:;letter-spacing:;',
 		'prbx_price_fstyle' 			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
 		'prbx_currency_fsize' 			=> 'font-size:13px;line-height:;letter-spacing:;',
 		'prbx_currency_fstyle' 			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
 		'prbx_unit_fsize' 				=> 'font-size:12px;line-height:;letter-spacing:;',
 		'prbx_unit_fstyle' 				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
 		'prbx_content_fsize'			=> 'font-size:14px;line-height:;letter-spacing:;',
 		'prbx_content_fstyle'			=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		...
		'prbx_btn_ftstyle'				=> 'font-family:Default;font-weight:inherit;font-style:inherit;',
		'prbx_btn_style'				=> 'none',
