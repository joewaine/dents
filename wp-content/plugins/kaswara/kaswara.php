...
define( 'KASWARA_PLUGIN_VERSION', '1.7' );
...
function kaswara_core_ressources_frontend_init(){
    ...
    global $post; if( stripos( $post->post_content, '[kswr_googlemaps') ) wp_enqueue_script('kswr_googleapis');
    if( stripos( $post->post_content, '[kswr_cf7') ) wp_enqueue_script('kswr_cf7-script');
    Kaswara_Icon_Manager::get_font_icons_load_styles(Kaswara_Icon_Manager::get_font_icons());  
}
