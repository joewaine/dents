...
function mg_shortcode( $atts, $content = null ) {
	...
	// grid container
	$grid .= $cust_styles . '<div id="mg_grid_'.$grid_id.'" class="mg_container '.$tit_under_class.' '.$search_box_class.' '.$ol_man->txt_vis_class.'" rel="'.$r_width.'" data-mg-pag="'.$curr_pag.'" '.$ol_man->img_fx_attr.'>' . mg_preloader();
