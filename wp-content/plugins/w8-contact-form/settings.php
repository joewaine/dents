	...
	class contact_form_slider_settings extends contact_form_slider {
		...
		**/
		function enqueue_admin_custom_scripts_and_styles() {
			...
			wp_localize_script( 'cfs_admin', 'cfs_admin_datas', array("plugin_directory"=>plugins_url( '/templates/assets/', __FILE__),"path"=>admin_url( 'admin-ajax.php'),"adminemail"=>get_bloginfo( 'admin_email' ),"languages"=>array("addimage"=>__( 'Add Image', W8CONTACT_FORM_TEXT_DOMAIN ),"remove"=>__( 'REMOVE', W8CONTACT_FORM_TEXT_DOMAIN ),"del"=>__( 'DELETE', W8CONTACT_FORM_TEXT_DOMAIN ),"entername"=>__( 'Enter the name', W8CONTACT_FORM_TEXT_DOMAIN ),"entertitle"=>__( 'Enter the title', W8CONTACT_FORM_TEXT_DOMAIN ),"entersubject"=>__( 'Enter the subject', W8CONTACT_FORM_TEXT_DOMAIN ),"emailaddress"=>__( 'Email address', W8CONTACT_FORM_TEXT_DOMAIN ),"description"=>__( 'Description', W8CONTACT_FORM_TEXT_DOMAIN ),"facebookurl"=>__( 'Facebook URL', W8CONTACT_FORM_TEXT_DOMAIN ),"googleplusurl"=>__( 'Google Plus URL', W8CONTACT_FORM_TEXT_DOMAIN ),"twitterurl"=>__( 'Twitter URL', W8CONTACT_FORM_TEXT_DOMAIN ),"pinteresturl"=>__( 'Pinterest URL', W8CONTACT_FORM_TEXT_DOMAIN ),"linkedinurl"=>__( 'LinkedIn URL', W8CONTACT_FORM_TEXT_DOMAIN ),"skypeurl"=>__( 'Skype Username', W8CONTACT_FORM_TEXT_DOMAIN ),"tumblrurl"=>__( 'Tumblr URL', W8CONTACT_FORM_TEXT_DOMAIN ),"flickrurl"=>__( 'Flickr URL', W8CONTACT_FORM_TEXT_DOMAIN ),"foursquareurl"=>__( 'Foursquare URL', W8CONTACT_FORM_TEXT_DOMAIN ),"youtubeurl"=>__( 'YouTube URL', W8CONTACT_FORM_TEXT_DOMAIN ),"sendername"=>__( 'Sender Name', W8CONTACT_FORM_TEXT_DOMAIN ),"senderemailaddress"=>__( 'Sender Email Address', W8CONTACT_FORM_TEXT_DOMAIN ),"message"=>__( 'Message', W8CONTACT_FORM_TEXT_DOMAIN ),"autoreply"=>__( 'Auto Reply', W8CONTACT_FORM_TEXT_DOMAIN ),"autoreplydesc"=>__( 'Leave the fields blank to disable autoreply or use the global autoreply option.', W8CONTACT_FORM_TEXT_DOMAIN ),"alllogs"=>__( 'All log entries has been deleted.', W8CONTACT_FORM_TEXT_DOMAIN ),"deletecontact"=>__( 'Delete Contact', W8CONTACT_FORM_TEXT_DOMAIN ),"clearlogs"=>__( 'Clear Logs', W8CONTACT_FORM_TEXT_DOMAIN ),"nolog"=>__( 'No log entries found.', W8CONTACT_FORM_TEXT_DOMAIN ),"name"=>__( 'Name', W8CONTACT_FORM_TEXT_DOMAIN ),"title"=>__( 'Title', W8CONTACT_FORM_TEXT_DOMAIN ),"subject"=>__( 'Subject', W8CONTACT_FORM_TEXT_DOMAIN ),"eaddress"=>__( 'Email Address', W8CONTACT_FORM_TEXT_DOMAIN ),"shortdesc"=>__( 'Short Description', W8CONTACT_FORM_TEXT_DOMAIN ),"cancel"=>__( 'Cancel', W8CONTACT_FORM_TEXT_DOMAIN ),"save"=>__( 'SAVE', W8CONTACT_FORM_TEXT_DOMAIN ),"saveerror"=>__( 'Error during the save process', W8CONTACT_FORM_TEXT_DOMAIN ),"successsave"=>__( 'Saved Successfully', W8CONTACT_FORM_TEXT_DOMAIN ))));
		...
		**/
		...
		$settings_page = '';
			...
			add_settings_field('contact_form_slider-setting_sendername', __( 'Sender Name', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_sendername', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_sendermail', __( 'Sender Email Address', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_sendermail', 'field_value' => '', 'other' => 'size="40"'));
			add_settings_field('contact_form_slider-setting_hide_icon', __( 'Hide icon', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_hide_icon', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_lock_screen', __( 'Lock screen', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_lock_screen', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_closeable', __( 'Display Close Icon', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_closeable', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_transparency', __( 'Background Transparency (percentage)', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_transparency', 'field_value' => '', 'other' => 'slider'));
			add_settings_field('contact_form_slider-setting_display_once_for_same_user', __( 'Display once per user', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_display_once_for_same_user', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_display_globally', __( 'Display globally', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_display_globally', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )." <i>".__( '(use [contact_form_slider] shortcode in the content)', W8CONTACT_FORM_TEXT_DOMAIN )."</i>"=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_auto_open', __( 'Auto open at bottom of the page', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_auto_open', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_sendcopy', __( 'Enable sending copy', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_sendcopy', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_disableimage', __( 'Hide Contact Photo', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_disableimage', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_captcha', __( 'Captcha', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_captcha', 'field_value' => '', 'options' => array(__( 'Image', W8CONTACT_FORM_TEXT_DOMAIN )=>"image",__( 'Math', W8CONTACT_FORM_TEXT_DOMAIN )=>"math",__( 'Hidden Field', W8CONTACT_FORM_TEXT_DOMAIN )=>"hidden",__( 'Disabled', W8CONTACT_FORM_TEXT_DOMAIN )=>"disabled"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_disable_on_mobile', __( 'Disable on mobile', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_disable_on_mobile', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_keep_settings', __( 'Keep Settings', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider', 'contact_form_slider-section', array('field' => 'setting_keep_settings', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			...
			add_settings_field('contact_form_slider-setting_vertical_distance', __( 'Icon Vertical Distance (5-95 / in percentage)', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_vertical_distance', 'field_value' => '', 'other' => 'slider'));
			add_settings_field('contact_form_slider-setting_icon_size', __( 'Icon size (the default icon only)', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_icon_size', 'field_value' => '', 'options' => array(__( 'Small', W8CONTACT_FORM_TEXT_DOMAIN )=>"small",__( 'Medium', W8CONTACT_FORM_TEXT_DOMAIN )=>"medium",__( 'Large', W8CONTACT_FORM_TEXT_DOMAIN )=>"large"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_direction', __( 'Direction', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_direction', 'field_value' => '', 'options' => array(__( 'Left', W8CONTACT_FORM_TEXT_DOMAIN )=>"left",__( 'Right', W8CONTACT_FORM_TEXT_DOMAIN )=>"right"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_icon_image', __( 'Default Icon', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_icon_image', 'field_value' => '', 'other' => 'iconimg'));
			add_settings_field('contact_form_slider-setting_icon_url', __( 'Icon url (optional - leave empty for default)', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_upload'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_icon_url', 'field_value' => '', 'other' => ''));
			add_settings_field('contact_form_slider-setting_animation', __( 'Animation', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_animation', 'field_value' => '', 'other' => 'animation'));
			add_settings_field('contact_form_slider-setting_reverseheader', __( 'Reverse Header Blocks', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_reverseheader', 'field_value' => '', 'options' => array(__( 'No', W8CONTACT_FORM_TEXT_DOMAIN )=>"off",__( 'Yes', W8CONTACT_FORM_TEXT_DOMAIN )=>"on"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_height', __( 'Height', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_height', 'field_value' => '', 'options' => array(__( 'Full', W8CONTACT_FORM_TEXT_DOMAIN )=>"full",__( 'Normal', W8CONTACT_FORM_TEXT_DOMAIN )=>"normal"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_bganim', __( 'Background Animation', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_bganim', 'field_value' => '', 'other' => 'bganim'));
			add_settings_field('contact_form_slider-setting_bgtarget', __( 'Background Animation Target', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_bgtarget', 'field_value' => '', 'other' => 'size="70" placeholder="#page" class="cfstooltip" data-title="Use this option if Background Animation has conflicts with your Theme. Specify the target div and the plugin will use as a background container."'));
			add_settings_field('contact_form_slider-setting_excludeelements', __( 'Exclude Elements from Animation', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_excludeelements', 'field_value' => '', 'other' => 'size="70" placeholder="#page" class="cfstooltip" data-title="Comma separated list of IDs and classes to exclude HTML elements from the Background Animation. Use it if you have a conflict with a Navigation Bar or any other elements."'));
			add_settings_field('contact_form_slider-setting_scheme', __( 'Style', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_scheme', 'field_value' => '', 'other' => 'scheme'));
			add_settings_field('contact_form_slider-setting_skin', __( 'Skin', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_skin', 'field_value' => '', 'other' => 'skin'));
			add_settings_field('contact_form_slider-setting_photostyle', __( 'Photo Style', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_photostyle', 'field_value' => '', 'other' => 'photostyle'));
			add_settings_field('contact_form_slider-setting_photoborder', __( 'Photo Border Color', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_photoborder', 'field_value' => '', 'options' => array(__( 'Disabled', W8CONTACT_FORM_TEXT_DOMAIN )=>"off","colorpicker"=>"colorpicker"), 'other' => '1'));
			add_settings_field('contact_form_slider-setting_shake', __( 'Icon animation', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_shake', 'field_value' => '', 'other' => 'shake'));
			add_settings_field('contact_form_slider-setting_fontfamily', __( 'Font Family', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_fontfamily', 'field_value' => '', 'other' => 'googlefonts'));
			add_settings_field('contact_form_slider-setting_headerfontsize', __( 'Name Font Size', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_headerfontsize', 'field_value' => '', 'other' => 'fontslider'));
			add_settings_field('contact_form_slider-setting_subheaderfontsize', __( 'Title Font Size', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_subheaderfontsize', 'field_value' => '', 'other' => 'fontslider'));
			add_settings_field('contact_form_slider-setting_pfontsize', __( 'Description Font Size', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_pfontsize', 'field_value' => '', 'other' => 'fontslider'));
			add_settings_field('contact_form_slider-setting_fieldfontsize', __( 'Fields Font Size', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_fieldfontsize', 'field_value' => '', 'other' => 'fontslider'));
			add_settings_field('contact_form_slider-setting_buttonfontsize', __( 'Button Font Size', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_buttonfontsize', 'field_value' => '', 'other' => 'fontslider'));
			add_settings_field('contact_form_slider-setting_headerfontweight', __( 'Name Font Weight', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_headerfontweight', 'field_value' => '', 'options' => array(__( 'Normal', W8CONTACT_FORM_TEXT_DOMAIN )=>"normal",__( 'Bold', W8CONTACT_FORM_TEXT_DOMAIN )=>"bold"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_subheaderfontweight', __( 'Title Font Weight', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_subheaderfontweight', 'field_value' => '', 'options' => array(__( 'Normal', W8CONTACT_FORM_TEXT_DOMAIN )=>"normal",__( 'Bold', W8CONTACT_FORM_TEXT_DOMAIN )=>"bold"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_pfontweight', __( 'Description Font Weight', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_pfontweight', 'field_value' => '', 'options' => array(__( 'Normal', W8CONTACT_FORM_TEXT_DOMAIN )=>"normal",__( 'Bold', W8CONTACT_FORM_TEXT_DOMAIN )=>"bold"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_fieldfontweight', __( 'Fields Font Weight', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_fieldfontweight', 'field_value' => '', 'options' => array(__( 'Normal', W8CONTACT_FORM_TEXT_DOMAIN )=>"normal",__( 'Bold', W8CONTACT_FORM_TEXT_DOMAIN )=>"bold"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_buttonfontweight', __( 'Button Font Weight', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_buttonfontweight', 'field_value' => '', 'options' => array(__( 'Normal', W8CONTACT_FORM_TEXT_DOMAIN )=>"normal",__( 'Bold', W8CONTACT_FORM_TEXT_DOMAIN )=>"bold"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_background', __( 'Background', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_background', 'field_value' => '', 'options' => array(__( 'Theme Default', W8CONTACT_FORM_TEXT_DOMAIN )=>"off","colorpicker"=>"colorpicker"), 'other' => '2'));
			add_settings_field('contact_form_slider-setting_defaultcolor', __( 'Default Text Color', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_defaultcolor', 'field_value' => '', 'options' => array(__( 'Theme Default', W8CONTACT_FORM_TEXT_DOMAIN )=>"off","colorpicker"=>"colorpicker"), 'other' => '5'));
			add_settings_field('contact_form_slider-setting_button_background', __( 'Submit Button Background', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_button_background', 'field_value' => '', 'options' => array(__( 'Theme Default', W8CONTACT_FORM_TEXT_DOMAIN )=>"off","colorpicker"=>"colorpicker"), 'other' => '3'));
			add_settings_field('contact_form_slider-setting_button_background_hover', __( 'Submit Button Background Hover', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_button_background_hover', 'field_value' => '', 'options' => array(__( 'Theme Default', W8CONTACT_FORM_TEXT_DOMAIN )=>"off","colorpicker"=>"colorpicker"), 'other' => '4'));
			add_settings_field('contact_form_slider-setting_buttoncolor', __( 'Submit Button Text Color', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_styles', 'contact_form_slider_styles-section', array('field' => 'setting_buttoncolor', 'field_value' => '', 'options' => array(__( 'Theme Default', W8CONTACT_FORM_TEXT_DOMAIN )=>"off","colorpicker"=>"colorpicker"), 'other' => '6'));
			...
			add_settings_field('contact_form_slider-setting_placeholder_name', __( 'Placeholder for name field', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_placeholder_name', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_placeholder_email', __( 'Placeholder for email field', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_placeholder_email', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_placeholder_message', __( 'Placeholder for message field', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_placeholder_message', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_placeholder_captcha', __( 'Placeholder for captcha field', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_placeholder_captcha', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_placeholder_sendcopy', __( 'Text for Send Copy checkbox', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_placeholder_sendcopy', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_sendbutton_text', __( 'Send button text', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_sendbutton_text', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_success_message', __( 'Success message', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_success_message', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_failed_text', __( 'Failed message', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_failed_text', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_default_translation', __( 'Use WordPress Translation Engine', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_translations', 'contact_form_slider_translations-section', array('field' => 'setting_default_translation', 'field_value' => '', 'options' => array(__( 'No', W8CONTACT_FORM_TEXT_DOMAIN )=>"off",__( 'Yes', W8CONTACT_FORM_TEXT_DOMAIN )=>"on"), 'other' => ''));
			...
			add_settings_field('contact_form_slider-setting_global_autoreply', __( 'Global Auto-Reply', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_autoreply', 'contact_form_slider_autoreply-section', array('field' => 'setting_global_autoreply', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => ''));
			add_settings_field('contact_form_slider-setting_global_arsendername', __( 'Sender Name', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_autoreply', 'contact_form_slider_autoreply-section', array('field' => 'setting_global_arsendername', 'field_value' => '', 'other' => 'size="70"'));
			add_settings_field('contact_form_slider-setting_global_arsenderemail', __( 'Sender Email Address', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_text'), 'contact_form_slider_autoreply', 'contact_form_slider_autoreply-section', array('field' => 'setting_global_arsenderemail', 'field_value' => '', 'other' => 'size="40"'));
			add_settings_field('contact_form_slider-setting_global_arsendermessage', __( 'Auto-Reply Message', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_textarea'), 'contact_form_slider_autoreply', 'contact_form_slider_autoreply-section', array('field' => 'setting_global_arsendermessage', 'field_value' => '', 'other' => 'rows="10" cols="70"'));
			...
			add_settings_field('contact_form_slider-setting_w8cfs_customcss', __( 'Enter you custom CSS code', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_textarea'), 'contact_form_slider_customcss', 'contact_form_slider_customcss-section', array('field' => 'setting_w8cfs_customcss', 'field_value' => '', 'other' => 'rows="20" cols="100" placeholder=".class {
	color: #000000;
}"'));
			...
			add_settings_field('contact_form_slider-setting_enable_logs', __( 'Logging Status', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_logs', 'contact_form_slider_logs-section', array('field' => 'setting_enable_logs', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => '', 'extrahtml' => '<div class="arrow_box"><p>' . __( 'Enable logging to save interactions with the contact form. Use it for testing purposes.', W8CONTACT_FORM_TEXT_DOMAIN ) . '</p></div>'));
			add_settings_field('contact_form_slider-setting_keep_logs', __( 'Keep Logs', W8CONTACT_FORM_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'contact_form_slider_logs', 'contact_form_slider_logs-section', array('field' => 'setting_keep_logs', 'field_value' => '', 'options' => array(__( 'On', W8CONTACT_FORM_TEXT_DOMAIN )=>"on",__( 'Off', W8CONTACT_FORM_TEXT_DOMAIN )=>"off"), 'other' => '', 'extrahtml' => '<div class="arrow_box"><p>' . __( 'Keep the logs after uninstall the plugin. Use it before updating the plugin to the new version.', W8CONTACT_FORM_TEXT_DOMAIN ) . '</p></div>'));
		}
		/**
		...
		**/
		public function settings_field_input_textarea($args)
		{
			...
			if ($field=="setting_global_arsendermessage") print('<br>'.__('Usable Tags:', W8CONTACT_FORM_TEXT_DOMAIN).' {name} {message} {subject} {email}');
		}
		/**
		...
		**/
		public function settings_field_input_select($args)
		{
			...
			echo sprintf('<select name="%s" id="%s" style="width: 200px;">', $field, $field);
					echo('<option value="light" '.selected($value,'light',false).'>'.__( 'Light', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="dark" '.selected($value,'dark',false).'>'.__( 'Dark', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
				echo('</select>');
			}
			elseif ($args['other']=='bganim')
			{
			echo sprintf('<select name="%s" id="%s" style="width: 200px;">', $field, $field);
					echo('<option value="disabled" '.selected($value,'disabled',false).'>'.__( 'Disabled', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_moveright" '.selected($value,'cfs_moveright',false).'>'.__( 'Move Right', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_moveleft" '.selected($value,'cfs_moveleft',false).'>'.__( 'Move Left', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_moveright_zoomout" '.selected($value,'cfs_moveright_zoomout',false).'>'.__( 'Move Right ZoomOut', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_moveleft_zoomout" '.selected($value,'cfs_moveleft_zoomout',false).'>'.__( 'Move Left ZoomOut', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_movebottomright_zoomout" '.selected($value,'cfs_movebottomright_zoomout',false).'>'.__( 'Move Bottom-Right ZoomOut', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_movebottomleft_zoomout" '.selected($value,'cfs_movebottomleft_zoomout',false).'>'.__( 'Move Bottom-Left ZoomOut', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_movetopright_zoomout" '.selected($value,'cfs_movetopright_zoomout',false).'>'.__( 'Move Top-Right ZoomOut', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_movetopleft_zoomout" '.selected($value,'cfs_movetopleft_zoomout',false).'>'.__( 'Move Top-Left ZoomOut', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_perspectiveleft" '.selected($value,'cfs_perspectiveleft',false).'>'.__( 'Perspective Left', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cfs_perspectiveright" '.selected($value,'cfs_perspectiveright',false).'>'.__( 'Perspective Right', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
				echo('</select>');
			}
			elseif ($args['other']=='skin')
			{
			echo sprintf('<select name="%s" id="%s" style="width: 200px;">', $field, $field);
					echo('<option value="default" '.selected($value,'default',false).'>'.__( 'Default', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="minimal" '.selected($value,'minimal',false).'>'.__( 'Minimal', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="woods" '.selected($value,'woods',false).'>'.__( 'Wood', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="blue-textil" '.selected($value,'blue-textil',false).'>'.__( 'Blue Textil', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="blue-tiles" '.selected($value,'blue-tiles',false).'>'.__( 'Blue Tiles', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="blurry-blue" '.selected($value,'blurry-blue',false).'>'.__( 'Blurry Blue', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="bubble-soap" '.selected($value,'bubble-soap',false).'>'.__( 'Bubble Soap', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="cracks" '.selected($value,'cracks',false).'>'.__( 'Cracks', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="elegant-darkblue" '.selected($value,'elegant-darkblue',false).'>'.__( 'Elegant Dark Blue', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="flower-lightblue" '.selected($value,'flower-lightblue',false).'>'.__( 'Flower Light Blue', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="green" '.selected($value,'green',false).'>'.__( 'Green', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="stripes-orange" '.selected($value,'stripes-orange',false).'>'.__( 'Stripes Orange', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="curved-wood" '.selected($value,'curved-wood',false).'>'.__( 'Curved Wood', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="decorated" '.selected($value,'decorated',false).'>'.__( 'Decorated', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="elegant-black" '.selected($value,'elegant-black',false).'>'.__( 'Elegant Black', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="lines" '.selected($value,'lines',false).'>'.__( 'Lines', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="pages1" '.selected($value,'pages1',false).'>'.__( 'Pages 1', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="pages2" '.selected($value,'pages2',false).'>'.__( 'Pages 2', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
					echo('<option value="wooden-floor" '.selected($value,'wooden-floor',false).'>'.__( 'Wooden Floor', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
				echo('</select>');
			}
			...
			echo sprintf('<select name="%s" id="%s" style="width: 200px;">', $field, $field);
					...
					echo('<option value="Elastic" '.selected($value,'Elastic',false).'>Elastic</option>');
					echo('<option value="Back" '.selected($value,'Back',false).'>Back</option>');
					echo('<option value="Bounce" '.selected($value,'Bounce',false).'>Bounce</option>');
				echo('</select>');
			}
			elseif ($args['other']=='iconimg')
			{
			echo sprintf('<select name="%s" id="%s" class="w8image-picker-select" style="width: 200px;">', $field, $field);
			...
			{
			echo sprintf('<select name="%s" id="%s" style="width: 200px;">', $field, $field);
					echo('<option value="off" '.selected($value,'off',false).'>'.__( 'Disabled', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
			...
			{
			echo sprintf('<select name="%s" id="%s" style="width: 200px;">', $field, $field);
					echo('<option value="0" '.selected($value,'0',false).'>'.__( 'Disabled', W8CONTACT_FORM_TEXT_DOMAIN ).'</option>');
		...
		**/		
		...
		public function plugin_settings_page() {
			if( ! current_user_can( 'manage_options' ) ) {
				wp_die(__('You do not have sufficient permissions to access this page.', W8CONTACT_FORM_TEXT_DOMAIN));
			}
		...
		public function ajax_cfs_admin() {
			if (isset($_REQUEST['cfscmd'])) $cfscmd = strip_tags($_REQUEST['cfscmd']);
			else $cfscmd = '';
			
			if ( $cfscmd == "addcustomfields" ) {
				update_option( 'cfs-custom-fields', sanitize_text_field( $_REQUEST[ 'options' ] ) );
				die('success');
			}
		}
	}
