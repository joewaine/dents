        ...
        if ( is_multisite() ) {
             include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
                if (is_plugin_active('wp-mega-menu-pro/wp-mega-menu-pro.php')) {
                 wp_die( __( 'You need to deactivate WP Mega Menu Pro Plugin in order to activate WP Mega Menu Free plugin.Please deactivate premium one. On deactivating premium plugin, your premium plugin data will not be removed.', APMM_PRO_TD ) );
