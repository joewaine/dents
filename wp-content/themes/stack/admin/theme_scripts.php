...
if(!( function_exists('ebor_load_scripts') )){
	function ebor_load_scripts() {
		...
		wp_enqueue_script( 'ebor-scripts-wp', EBOR_THEME_DIRECTORY . 'style/js/scripts_wp.js', array('jquery'), false, true  );
		...
		wp_localize_script( 'ebor-scripts', 'stack_data', $script_data );
