...
<div class="bar__module stack-header-buttons">
	...
	<?php if( $button_1_link ) : ?>
		<a class="btn btn--sm type--uppercase" href="<?php echo esc_url($button_1_link); ?>" target="<?php echo esc_attr(get_option('stack_header_button_target_1')); ?>">
			<span class="btn__text"><?php echo wp_kses_post(get_option('stack_header_button_text_1', 'Try Stack')); ?></span>
		</a>
	<?php endif; ?>
	
	<?php if( $button_2_link ) : ?>
		<a class="btn btn--sm btn--primary type--uppercase" href="<?php echo esc_url($button_2_link); ?>" target="<?php echo esc_attr(get_option('stack_header_button_target_2')); ?>">
