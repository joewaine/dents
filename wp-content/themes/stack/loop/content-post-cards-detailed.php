<div id="post-<?php the_ID(); ?>" <?php post_class('masonry__item col-sm-6 col-md-4'); ?>>
	<article class="feature feature-1 pricing-1">
		...
		<div class="feature__body boxed boxed--border">
			...
			?>
			<span class="type--fine-print"><?php the_time(get_option('date_format')); ?> &bull; <?php comments_number( esc_html__('0 Comments','stack'), esc_html__('1 Comment','stack'), esc_html__('% Comments','stack') ); ?></span>
			<?php 
