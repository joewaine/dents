						...
						<div>
							<?php
								if ( ! $product_permalink ) {
									...
									echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<h5 class="inline">%s</h5><span>%s</span>', $_product->get_title(), strip_tags(wc_get_product_category_list($_product->get_id())) ), $cart_item, $cart_item_key );
								}
