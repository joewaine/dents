...
2. Same as content width', 'tilt' ),
			...
			twc_blog_grid_layout('blog_grid_layout', 'Main blog page' ),
			twc_blog_grid_layout('archive_grid_layout', 'Blog archive' ),
			array(
				'id'          => 'content_type',
			...
			array(
				...
				'label'       => __( 'Portfolio archive layout', 'tilt' ),
				'desc'        => __( '1. Full width content <br />
									2. Content / Right sidebar <br />
									3. Content / Left sidebar', 'tilt' ),
				'std'         => 'full-width',
			...
			twc_blog_grid_layout('portfolio_archive_grid_layout', 'Portfolio archive' ),
			array(
				'id'          => 'woocommerce_tab',
...
Have fun!', 'tilt' ),
			...
			array(
				...
				'desc'        => __( '	<h1 class="import_heading">Welcome to Tilt</h1>
										<a class="import_img" href="http://themes.whiteboxstud.io/tilt/" target="_blank"><img src="http://whiteboxstud.io/envato/tilt/demo_data/demo_import_img.png"></a>
